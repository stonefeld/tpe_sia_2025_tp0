...
class PokemonFactory:
    ...
    def create(self, name: str, level: int, status: StatusEffect, hp_percentage: float) -> Pokemon:
        ...
        with open(self._src_file, "r") as c:
            ...
            new_pokemon = Pokemon(name, type, 0, status, level, stats, poke["catch_rate"], poke["weight"])
